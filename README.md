...
| send_stories (необязательно) | Отправлять ли истории? Возможные значения: 0 (no), 1 (yes). По умолчанию: 0 |
...
| send_stories (необязательно) | Отправлять ли истории (переопределяет значение из `global`)? Возможные значения: 0 (no), 1 (yes) |
