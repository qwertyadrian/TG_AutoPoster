...
|   topic_id (необязательно)    |                                                                                                                                                                          Один или несколько ID тем чата в Telegram, в которые отправлять посты из групп ВК (**их должно быть меньше или равно количеству ID чатов**)                                                                                                                                                                           |
